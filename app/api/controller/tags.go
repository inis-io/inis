...
// all 获取全部数据
func (this *Tags) all(ctx *gin.Context) {
...
// rand 随机获取
func (this *Tags) rand(ctx *gin.Context) {
	...
	item := facade.DB.Model(&model.Tags{}).OnlyTrashed(onlyTrashed).WithTrashed(withTrashed)
	...
	// 查询条件
	mold := facade.DB.Model(&[]model.Tags{}).Where("id", "IN", ids)
...
// save 保存数据 - 包含创建和更新
func (this *Tags) save(ctx *gin.Context) {
...
// create 创建数据
func (this *Tags) create(ctx *gin.Context) {
	...
	// 表数据结构体
	table := model.Tags{CreateTime: time.Now().Unix(), UpdateTime: time.Now().Unix()}
	allow := []any{"name", "description", "avatar", "json", "text"}
...
// update 更新数据
func (this *Tags) update(ctx *gin.Context) {
...
// count 统计数据
func (this *Tags) count(ctx *gin.Context) {
...
// column 获取单列数据
func (this *Tags) column(ctx *gin.Context) {
...
// remove 软删除
func (this *Tags) remove(ctx *gin.Context) {
...
// delete 真实删除
func (this *Tags) delete(ctx *gin.Context) {
...
// clear 清空回收站
func (this *Tags) clear(ctx *gin.Context) {
...
// restore 恢复数据
func (this *Tags) restore(ctx *gin.Context) {
